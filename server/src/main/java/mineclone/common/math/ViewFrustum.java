...
public class ViewFrustum {
	 ...
	 * {@link #pointInView(Vec3)} and {@link #sphereInView(Vec3, float)}. This
	 ...
	 * 
	 * @see #pointInView(Vec3)
	 * @see #pointInView(float, float, float)
	 * @see #sphereInView(Vec3, float)
	 * @see #sphereInView(float, float, float, float)
	 */
	public void initFrustum(Mat4 pvm) {
		// LEFT RIGHT
	 ...
	 * {@link #initFrustum(Mat4)} prior to calling this method.
	 * 
	 ...
	 * 
	 * @see #initFrustum(Mat4)
	 */
	public boolean pointInView(Vec3 point) {
	 ...
	 * @see #initFrustum(Mat4)
	 */
	public boolean sphereInView(Vec3 center, float radius) {
	...
	private class Plane {
		 ...
		 * 
		 * @see ViewFrustum#initFrustum(Mat4)
		 */
		public void set(float a, float b, float c, float d) {
			...
			if (lenSqr > LinMath.EPSILON * LinMath.EPSILON) {
				float s = 1.0f / (float)Math.sqrt(lenSqr);
				this.a *= s;
				this.b *= s;
				this.c *= s;
